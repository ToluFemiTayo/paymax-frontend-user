                    ...
                    <div class="card mb-4">
                        <div class="card-header text-uppercase text-primay">
                            <div class="row">
                                ...
                                <div class="col-lg-10">
                                    <h5 class="mt-3 font-weight-bold text-primary">Eko Electricity Distribution
                                        Company</h5>
                                </div>
                                <div class="col-lg-2 d-none d-md-block">
                                    <img src="https://www.payvice.com/assets/img/util_ekedc.png" height="60" width="60"
                                        class="img-thumbnail">
                                </div>
                            </div>
                        </div>
                                    ...
                                    <div id="prepaid-first" v-if="meter.name == null">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" value="" class="form-control" data-bv-field="payerName"
                                                id="payerName" v-model="meter.meter_no" placeholder="">
                                        </div>
                                    </div>
...
<script>
    import {
        EKO_METER_VALIDATION,
        EKO_PREPAID_PURCHASE,
        EKO_POSTPAID_PURCHASE,
    ...
    export default {
        ...
        methods: {
            ...
            checkMeter(type) {
                switch(type) {
                case "prepaid":
                    return this.meter.name == null ? EKO_METER_VALIDATION : EKO_PREPAID_PURCHASE
                    break;
                case "postpaid":
                    return this.meter.name == null ?  EKO_METER_VALIDATION : EKO_POSTPAID_PURCHASE
                    break;
                default:
                    let x = this.error
