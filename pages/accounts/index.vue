<template>
  <div class="swiper__backgroundslide">

    <!-- Slideshow      -->
      <Slider :images="images" />
    <!-- Slideshow end -->

    <div class="backgroundslide__overlay">
      <div class="overlay__content">

        <!-- login form -->
        <div class="container-slide-login">
...
export default {
  ...
  data() {
    return {
      images: [
        {
          src: "/bgslide/image-3.jpg",
          alt: "Banner"
        },
        {
          src: "/bgslide/image-5.jpg",
          alt: "Banner"
        },
        {
          src: "/bgslide/image-7.jpg",
          alt: "Banner"
        }
      ],
      type: "login",
